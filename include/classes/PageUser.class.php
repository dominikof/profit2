...
//        $this->Asked = &check_init('AskedLayout', 'AskedLayout', "NULL, NULL, NULL, null");
    ...
    */
	...
	<script type="text/javascript" src="/include/js/fancybox2.0.6/helpers/jquery.fancybox-buttons.js"></script>
	<script type="text/javascript" src="/include/js/fancybox2.0.6/helpers/jquery.fancybox-thumbs.js"></script>
	<link href="/include/js/fancybox2.0.6/jquery.fancybox.css" type="text/css" rel="stylesheet" />
	<link href="/include/js/fancybox2.0.6/helpers/jquery.fancybox-buttons.css" type="text/css" rel="stylesheet" />
	<link href="/include/js/fancybox2.0.6/helpers/jquery.fancybox-thumbs.css" type="text/css" rel="stylesheet" />
