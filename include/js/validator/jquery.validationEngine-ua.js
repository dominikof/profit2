        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextCheckboxMultiple": "* Ви повинні oбрати варіант",
                    "alertTextCheckboxe": "* Необхідно зазначити"
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Мінімум ",
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Ви повинні заповнити одне з наведених полів"
                },
                "min": {
                    "regex": "none",
                    "alertText": "* Минімальне значення "
                },
                "max": {
                    "regex": "none",
                ...
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "* Не можна обрати стільки варіантів"
                },
                "minCheckbox": {
                    "regex": "none",
                ...
                "phone": {
                    ...
                    "alertText": "* Неправильний формат телефона"
                },
                "email": {
                ...
                "date": {
                    ...
                    "alertText": "* Невірна дата (повинно бути в ДД.MM.РРРР форматі)"
                },
                "ipv4": {
                	"regex": /^((([01]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))[.]){3}(([0-1]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))$/,
                    "alertText": "* Невірна IP-адреса"
                },
                "url": {
