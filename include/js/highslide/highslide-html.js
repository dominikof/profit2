...
hs.htmlExpand = function(a, params, form, id_cat, date, prod_id) {
post_data = ajaxAddProductHide(form);
newDiv(id_cat, date, prod_id, post_data); 
...
HsExpander.prototype.htmlOnClose = function(id_prod) {
