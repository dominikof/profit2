...
// ================================================================================================
 ...
 class DBs {
        ...
        protected function DBs($config=NULL) {
//            $item=microtime();
...
//                $this->sql =$sql;
                ...
                //echo '<br> $this->$SINGLEsql='.$sql;
//                    $dva= microtime()-$init;
//                 echo '<br> $this->$SINGLEsql='.$sql.'<br />time='.$dva.'<br />'.$this->conn;
                if( !$this->result )
                {
                        $this->db_SetError();
                }
...
//                echo '<br />',$this->sql;
       ...
       function IsFieldExist($Table, $field )
       {
           ...
           $res = $this->db_Query($q);
           //echo '<br>q='.$q.' res='.$res.' $this->result='.$this->result;
           if ( !$res OR !$this->result ) return false;
