...
include_once( SITE_PATH.'/admin/include/defines.inc.php' );
        ...
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/images/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,exel,exelx,ppt,pptx,zip,rar,pdf";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,exel,exelx,ppt,pptx,zip,rar,pdf";
