...
function getFreeFileName($fileName, $dir)
{
	...
	$dotPos= strrpos($fileName, '.', null);

	$fname = substr($fileName, 0, strrpos($fileName, '.', null));
...
function isWork()
{
	...
	$ext = array('json_encode', 'internal_encoding', 'substr', 'ereg_replace', 'strlen', 'imagecreatetruecolor', 'imagefill', 'imagecopyresampled', 'imagejpeg', 'imagedestroy');
